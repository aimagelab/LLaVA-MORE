...
from src.llava.utils import disable_torch_init
from src.llava.mm_utils import (
    process_images,
...
def eval_model(args):
    ...
    k = dict(model_architecture=args.model_architecture)
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        args.model_path, args.model_base, model_name, **k
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-architecture", type=str, default="llama_3_1")    
